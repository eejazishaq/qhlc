...
BEGIN
    ...
    -- Get area ID
    SELECT id INTO area_id FROM areas WHERE code = area_code LIMIT 1;
    
    -- Get first center in that area
    SELECT id INTO center_id FROM exam_centers WHERE area_id = area_id LIMIT 1;
