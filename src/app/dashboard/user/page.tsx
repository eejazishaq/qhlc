...
import { BookOpen, Calendar, Award, Clock, User, BarChart3, TrendingUp, CheckCircle, AlertCircle, GraduationCap, RefreshCw } from 'lucide-react'
          ...
          <Link href="/dashboard/user/exams" className="block">
            <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6 hover:shadow-md transition-all duration-200 cursor-pointer group">
              <div className="flex items-center justify-between">
                ...
                <BookOpen className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 flex-shrink-0 ml-3" />
              </div>
            </div>
          </Link>
