-- Fresh Database Setup - Run this in your Supabase SQL Editor
-- This creates a clean database without any RLS policies

-- First, let's clean up everything
...
-- NO RLS POLICIES - We'll add them later after everything is working 